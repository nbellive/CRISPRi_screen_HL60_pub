...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220216/20220216_SC575_sgCtrl1_Heochst_Epi_BF_60secFR_3umZ_1/*t.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220216_KDlines_3D/20220216_sgCtrl1_1_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220216_KDlines_3D/20220216_sgCtrl1_1_tracks.csv')
