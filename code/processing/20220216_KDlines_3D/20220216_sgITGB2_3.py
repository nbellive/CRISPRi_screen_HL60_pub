...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220216/20220216_SC575_sgITGB2_Heochst_Epi_BF_60secFR_3umZ_3/*t.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220216_KDlines_3D/20220216_sgITGB2_3_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220216_KDlines_3D/20220216_sgITGB2_3_tracks.csv')
