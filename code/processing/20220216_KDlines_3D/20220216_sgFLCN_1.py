...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220216/20220216_SC575_sgFLCN_Heochst_Epi_BF_60secFR_3umZ_1/*t.ome.tif')
print(files)


celltype = 'HL-60KW_SC575_sgFLCN'
acqtime = '60sec'
threshold = 800#650

analysis_date = 20220302
framerate = 'NA'
date = 20220216
...
#
df_track.to_csv('../../../data/processed_tracking/20220216_KDlines_3D/20220216_sgFLCN_1_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220216_KDlines_3D/20220216_sgFLCN_1_tracks.csv')
