...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220302/20220302_AG++SC575_sgCORO1A_20x_60sFR_Heochst_BF_0.75mgmlCollagen_1/*0.ome.tif')
print(files)


celltype = 'HL-60AG++_SC575_sgCORO1A'
acqtime = '60sec'
threshold = 800#650

analysis_date = 20220308
framerate = 'NA'
date = 20220302
...
#
df_track.to_csv('../../../data/processed_tracking/20220302_KDlines_3D/20220302_sgCORO1A_0_75_1_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220302_KDlines_3D/20220302_sgCORO1A_0_75_1_tracks.csv')
