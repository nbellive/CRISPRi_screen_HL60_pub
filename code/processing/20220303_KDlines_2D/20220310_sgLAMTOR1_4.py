...
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/Rio/20220303_2D_10nMrapamycin/20220303_20x_KWSC575_sgLAMTOR1_5dDMSO_Ibidi_FN10ugml_30secFR_phase_Heochst_flask2_2/*Pos0.ome.tif')
print(files)
...
trial = 4
media = 'L-15_10%FBS'
misc = '10ug/ml fibronectin, 10 nM rapamycin, flask2'
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220303_2D_10nMrapamycin/20220303_sgLAMTOR1_10nMrapamycin_4_tracks.csv')
