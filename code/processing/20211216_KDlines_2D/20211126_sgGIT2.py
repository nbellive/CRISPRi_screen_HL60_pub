...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/Rio/20211216_KDlines_5dayDMSO/20211126_sgGIT2_5dDMSO_ibidi_30sec_1/*Pos0.ome.tif')
print(files)
...
#
# save to file
df_track.to_csv('20211126_sgGIT2_tracks.csv')
