...
######################################
files= glob.glob('../../../../../../../Volumes/ExpansionHomesA//nbelliveau/Microscopy_RAW/Rio/20220920_kdLines/20220920_20xair_KWSC575_sgGIT2_dHL-60_FNcoated_30sec_slide2_3/*Pos0.ome.tif')
print(files)
...
trial = 6
media = 'L-15_10%FBS'
misc = '10ug/ml fibronectin, slide 2'
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220920_KDlines_2D/20220920_sgGIT2_6_tracks.csv')
