...
######################################
files= glob.glob('../../../../../../../Volumes/Belliveau_RAW_3_JTgroup/Microscopy_RAW/iSIM/xIon/20220426/20220426_KW_SC575_sgFMNL1_Heochst_Epi_BF_60secFR_3umZ_4/*0.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220426_KDlines_3D/20220426_sgFMNL1_0_75_2_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220426_KDlines_3D/20220426_sgFMNL1_0_75_2_tracks.csv')
