...
######################################
files= glob.glob('../../../../../../../Volumes/Belliveau_RAW_3_JTgroup/Microscopy_RAW/iSIM/xIon/20220426/20220426_KW_SC575_sgCORO1A_Heochst_Epi_BF_60secFR_3umZ_2/*0.ome.tif')
print(files)


celltype = 'HL-60KW_SC575_sgCORO1A'
acqtime = '60sec'
threshold = 800
...
#
df_track.to_csv('../../../data/processed_tracking/20220426_KDlines_3D/20220426_sgCORO1A_0_75_2_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220426_KDlines_3D/20220426_sgCORO1A_0_75_2_tracks.csv')
