...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220316/20220316_KWSC575_sgCtrl1_20x_60sFR_Heochst_BF_0.75mgmlCollagen_1/*0.ome.tif')
print(files)


celltype = 'HL-60KW_SC575_sgCtrl1'
acqtime = '60sec'
threshold = 1200
...
#
df_track.to_csv('../../../data/processed_tracking/20220316_KDlines_3D/20220316_sgCtrl1_0_75_1_tracks_1200Thresh.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220316_KDlines_3D/20220316_sgCtrl1_0_75_1_tracks_1200Thresh.csv')
