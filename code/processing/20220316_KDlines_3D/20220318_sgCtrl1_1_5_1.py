...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220316/20220316_KWSC575_sgCtrl1_20x_60sFR_Heochst_BF_1.5mgmlCollagen_1_1/*0.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220316_KDlines_3D/20220316_sgCtrl1_1_5_1_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220316_KDlines_3D/20220316_sgCtrl1_1_5_1_tracks.csv')
