...
files= glob.glob('../../../data/microscopy/20220215_KD_FNIbidi/20220215_20x_KW-SC575_sgLAMTOR1_5dDMSO_FNcoat_30secFR_Heochst_phase_1/*Pos0.ome.tif')
print(files)
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220215_KDlines/20220215_sgLAMTOR1_tracks.csv')
