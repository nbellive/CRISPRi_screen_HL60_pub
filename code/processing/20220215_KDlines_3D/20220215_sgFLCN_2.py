...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220215/20220215_SC575_sgFLCN_Heochst_Epi_BF_60secFR_3umZ_2/*t.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220215_KDlines_3D/20220215_sgFLCN_2_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220215_KDlines_3D/20220215_sgFLCN_2_tracks.csv')
