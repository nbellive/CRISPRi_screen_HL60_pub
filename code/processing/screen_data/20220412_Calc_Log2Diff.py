...
#################################
df_compare.columns = ['sgRNA', 'gene', 'diff']
df_compare.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_growth_all.csv')
...
df_mean['gene'] = [i[0] for i in df_mean.gene.values]

#cleanup dataframe columns
df_mean = df_mean[['gene', 'sgRNA', 'diff']]
df_mean.columns = ['gene', 'sgRNA', 'log2fold_diff_mean']

df_mean.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_growth_sgRNA_means.csv')
...
#################################
df_compare.columns = ['sgRNA', 'gene', 'diff']
df_compare.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_differentiation_all.csv')
...
df_mean.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_differentiation_sgRNA_means.csv')
...
#################################
df_compare.columns = ['sgRNA', 'gene', 'diff']
df_compare.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_tracketch_0_6hr_all.csv')
...
df_mean.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_tracketch_0_6hr_sgRNA_means.csv')
...
#################################
df_compare.columns = ['sgRNA', 'gene', 'diff']
df_compare.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_tracketch_10_6hr_all.csv')
...
df_mean.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_tracketch_10_6hr_sgRNA_means.csv')
...
#################################
df_compare.columns = ['sgRNA', 'gene', 'diff']
df_compare.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_tracketch_0_2hr_all.csv')
...
df_mean.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_tracketch_0_2hr_sgRNA_means.csv')
...
#################################
df_compare.columns = ['sgRNA', 'gene', 'diff']
df_compare.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_tracketch_10_2hr_all.csv')
...
df_mean.to_csv('../../../data/screen_summary/log2foldchange/temp/20220412_screen_log2fold_diffs_tracketch_10_2hr_sgRNA_means.csv')
...
# a bit of count threshold filtered
# (based on some initial observations looking at plots of the counts)
...
#################################
df_compare.columns = ['sgRNA', 'gene', 'diff']
df_compare_ECM.to_csv('../../../data/screen_summary/log2foldchange/temp/20220516_screen_log2fold_diffs_ECM_all.csv')
...
df_mean.to_csv('../../../data/screen_summary/log2foldchange/temp/20220516_screen_log2fold_diffs_ECM_sgRNA_means.csv')
...
# # Save collated log2fold change values to disk
# #################################
# df_compare_ECM.to_csv('../../../data/screen_summary/log2foldchange/temp/20220516_screen_log2fold_diffs_ECM_all_4.csv')
#
# #################################
# # Calculate mean values for each sgRNA and save to disk
# #################################
...
# df_mean.columns = ['gene', 'sgRNA', 'log2fold_diff_mean']
#
# df_mean.to_csv('../../../data/screen_summary/log2foldchange/temp/20220516_screen_log2fold_diffs_ECM_sgRNA_means_4.csv')
