...
######################################
files= glob.glob('../../../../../../../Volumes/Belliveau_RAW_3_JTgroup/Microscopy_RAW/iSIM/xIon/20220428/20220428_KW_SC575_sgCORO1A_Heochst_Epi_BF_60secFR_3umZ_1/*0.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220428_KDlines_3D/20220428_sgCORO1A_0_75_1_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220428_KDlines_3D/20220428_sgCORO1A_0_75_1_tracks.csv')
