...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220307/20220307_AG++SC575_sgCtrl1_20x_60sFR_Heochst_BF_0.75mgmlCollagen_2/*0.ome.tif')
print(files)


celltype = 'HL-60AG++_SC575_sgControl1'
acqtime = '60sec'
threshold = 800#650
...
#
df_track.to_csv('../../../data/processed_tracking/20220307_KDlines_3D/20220307_sgCtrl1_0_75_2_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220307_KDlines_3D/20220307_sgCtrl1_0_75_2_tracks.csv')
