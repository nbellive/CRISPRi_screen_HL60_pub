...
files= glob.glob('../../../data/microscopy/20220208_KD_FNIbidi/20220208_KW-SC575_sgLAMTOR1_5dDMSO_FNcoat_30secFR_Heochst_phase_2/*Pos0.ome.tif')
print(files)
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220208_KDlines/20220208_sgLAMTOR1_2_tracks.csv')
