...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220214/20220214_SC575_sgCtrl1_Heochst_Epi_BF_60secFR_3umZ_2/*t.ome.tif')
...
#
df_track.to_csv('../../../data/processed_tracking/20220214_KDlines_3D/20220214_sgCtrl1_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220214_KDlines_3D/20220214_sgCtrl1_tracks.csv')
