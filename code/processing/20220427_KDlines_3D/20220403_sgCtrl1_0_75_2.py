...
######################################
files= glob.glob('../../../../../../../Volumes/Belliveau_RAW_3_JTgroup/Microscopy_RAW/iSIM/xIon/20220427/20220427_KW_SC575_sgCtrl1_Heochst_Epi_BF_60secFR_3umZ_2/*0.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220427_KDlines_3D/20220427_sgCtrl1_0_75_2_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220427_KDlines_3D/20220427_sgCtrl1_0_75_2_tracks.csv')
