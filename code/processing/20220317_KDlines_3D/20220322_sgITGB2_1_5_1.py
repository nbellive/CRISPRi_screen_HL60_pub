...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220317/20220317_KWSC575_sgITGB2_20x_60sFR_Heochst_BF_1.5mgmlCollagen_1/*0.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220317_KDlines_3D/20220317_sgITGB2_1_5_1_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220317_KDlines_3D/20220317_sgITGB2_1_5_1_tracks.csv')
