...
######################################
files= glob.glob('../../../../../../../Volumes/homes//nbelliveau/Microscopy_RAW/iSIM/xIon/20220317/20220317_KWSC575_sgITGA1_20x_60sFR_Heochst_BF_0.75mgmlCollagen_2/*0.ome.tif')
print(files)
...
#
df_track.to_csv('../../../data/processed_tracking/20220317_KDlines_3D/20220317_sgITGA1_0_75_2_tracks.csv')
...
# save to file
df_track_lab.to_csv('../../../data/processed_tracking/20220317_KDlines_3D/20220317_sgITGA1_0_75_2_tracks.csv')
