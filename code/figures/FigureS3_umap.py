...
df_counts_normed = pd.read_csv('../../data/rnaseq_processed/NB_counts_NBanalysis_matrix_normed_wATIC_d0Only.csv')
...
reducer = umap.UMAP(n_components = 2, random_state=82)#, random_state=42)
...
plt.tight_layout()
fig.savefig('../../figures/FigS3_ATIC_rnaseq_d0Only_.pdf', bbox_inches='tight')
