...
if __name__ == "__main__":
    ...
    filelist_fl = ['/Volumes/Belliveau_RAW_1_JTgroup/Rio/20190116/20190116_dHL60_20x_ibidi_1mgml_collagen_50Vsaltbridge_25V_4/20190116_Rio_20xair_66_5_dHL60_collagen_1.0mgml_4_405.tif']
...
#         break
    ...
    # subpixel precision
    if t != 0:
        im_fname_bf_t0 = os.path.dirname(filelist_fl[0]) + '/images/' + fname_pre + '_brightfield_t' + str(t).zfill(3)  + '_z'+ str(1).zfill(3) + '.tif'
        im_bf_t0 = skimage.io.imread(im_fname_bf_t0)
        im_fname_bf_t1 = os.path.dirname(filelist_fl[0]) + '/images/' + fname_pre + '_brightfield_t' + str(t+1).zfill(3)  + '_z'+ str(1).zfill(3) + '.tif'
