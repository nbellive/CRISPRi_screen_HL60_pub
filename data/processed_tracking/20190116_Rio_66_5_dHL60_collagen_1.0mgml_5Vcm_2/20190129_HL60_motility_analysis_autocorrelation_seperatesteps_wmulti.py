        ...
        for i, prop in enumerate(im_props):
            if im_labeled_temp[int(prop.centroid[0]),int(prop.centroid[1])] == 0:
                ...
                data = {'cell':count, 'frame':t, 'framerate':framerate, 'x':x, 'y':y, 'z':z_pos,
                        ...
                        'trial':2, 'x_corr':shift[1], 'y_corr':shift[0], 'fMLP':fmlp, 'E_field':efield}
...
if __name__ == "__main__":
    ...
    filelist_fl = ['/Volumes/Belliveau_RAW_1_JTgroup/Rio/20190116/20190116_dHL60_20x_ibidi_1mgml_collagen_50Vsaltbridge_25V_2/20190116_Rio_20xair_66_5_dHL60_collagen_1.0mgml_1_405.tif']
